    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-brand p-8 sm:p-12 rounded-lg border border-gray-200 shadow-sm">
        ...
        <p className="mt-4 text-gray-200">
          If your business, museum, or gallery has a location dedicated to displaying items, your support is crucial. By signing, you help us demonstrate the real-world need for this property to the schema.org community.
        </p>
        ...
        {submitted ? (
          <div className="mt-8 p-4 bg-green-100 text-green-800 border border-green-200 rounded-md">
            ...
            <p>Please check your email to confirm your support. Your entry will be publicly listed after you click the confirmation link in the email we've just sent you.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            <div>
              ...
              <input 
                ...
                className="mt-1 block w-full px-3 py-2 bg-brand-dark text-white border border-gray-500 rounded-md placeholder-gray-400 focus:outline-none focus:ring-accent focus:border-accent sm:text-sm" 
                required 
              />
            </div>
            <div>
            ...
            <div>
              <label htmlFor="company" className="block text-sm font-medium text-gray-200">Company / Organization</label>
              <input 
                type="text" 
                name="company" 
                id="company" 
            ...
            <p className="text-xs text-gray-300 text-center">
                By signing this petition, you agree that your name, role, and company name may be published on the list of supporters after email verification.
            </p>
          </form>
        )}
      </div>
